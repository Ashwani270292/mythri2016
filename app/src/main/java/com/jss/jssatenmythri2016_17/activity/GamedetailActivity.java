    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (data) {
            case "Badminton": {
                ...
                studentThreeName.setText("Aishwarya Choudhary(CE/4th yr)");
                facultyName.setText("Mr. Vikas Singhal\nAP-MCA");
                facultyImage.setImageResource(R.drawable.vikas_singhal);
                facualtyCoordinatorTwo.setVisibility(View.GONE);
                studentOneImage.setImageResource(R.drawable.prashant_coordinator_badminton);
                studentTwoImage.setImageResource(R.drawable.abhigyan_badminton);
                studentThreeImage.setImageResource(R.drawable.aishwarya_badminton);
            ...
            case "Table Tennis": {
                ...
                studentOneImage.setImageResource(R.drawable.sachin_tt);
            ...
            case "Chess": {
                ...
                studentOneImage.setImageResource(R.drawable.deepesh_chess);
            ...
            case "Carrom": {
                ...
                facultyName2.setText("Mr. Amit kumar Roy\nAP-EE");
                studentOneContact.setText("9412190056");
                studentTwoContact.setText("9560746831");
                studentOneImage.setImageResource(R.drawable.pulkit_carrom);
                studentTwoImage.setImageResource(R.drawable.amit_carrom);
                facultyImage.setImageResource(R.drawable.nirmal);
                facultyImage2.setImageResource(R.drawable.amit_kumar_roy);
                studentCoordinatorThree.setVisibility(View.GONE);
            ...
            case "Tug Of War": {
                ...
                studentOneImage.setImageResource(R.drawable.rajat_sachan);
                studentTwoImage.setImageResource(R.drawable.gaurav_kumar);
                studentThreeImage.setImageResource(R.drawable.akrita_tug_of_war);
            ...
            case "Cricket": {
                ...
                studentTwoName.setText("Rishab(MCA/2nd yr)");
                facultyName.setText("Mr. Vikas Kumar Singla\nAP-ME");
                studentOneContact.setText("8882382568");
                studentTwoContact.setText("7351341642");
                studentOneImage.setImageResource(R.drawable.saurabh_cricket);
                studentTwoImage.setImageResource(R.drawable.rishab_cricket);
            ...
            case "Football": {
                ...
                facultyName.setText("Mr.Harsh Vardhan Pundir\nAP-ENGLISH");
            ...
            case "Volleyball": {
                ...
                facultyName.setText("Mr.Birendra Kumar Verma\nAP-IT");
                studentOneContact.setText("9015835358");
                studentTwoContact.setText("7838267666");
                facultyImage.setImageResource(R.drawable.birendra_verma);
                studentOneImage.setImageResource(R.drawable.govind_yadav_volleyball);
                studentTwoImage.setImageResource(R.drawable.simran_chawla);
            ...
            case "Basketball": {
                ...
                facultyName2.setText("Nikunj Agarwal\nAP-MATHS");
                studentOneImage.setImageResource(R.drawable.sarthak_dutta_coordinator_basketball);
                studentTwoImage.setImageResource(R.drawable.shraddha_basketball);
                facultyImage.setImageResource(R.drawable.girish_sir_ped);
            ...
            case "Kabaddi": {
                ...
                studentOneImage.setImageResource(R.drawable.manish_kumar_kabbadi);
            ...
            case "Fun Games": {
                ...
                studentOneImage.setImageResource(R.drawable.jugal_fun_games);
                studentTwoImage.setImageResource(R.drawable.girish_fun_games);
            ...
            case "100m 3 Three Legged Race": {
                title.setText(data);
                studentOneName.setText("Saurabh(IC/4th yr)");
                studentTwoName.setText("Bulusu Chandrika(IC/4th yr)");
                facultyName.setText("Dr. Kushalendraprathap Singh\nAP-PHYSICS");
                studentOneContact.setText("9871310842");
                studentTwoContact.setText("9810863590");
                type.setText("None");
                studentOneImage.setImageResource(R.drawable.saurabh_three_legged_race);
